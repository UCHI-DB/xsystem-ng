...
//Branch Layer of the XStructure
	...
	public Branch(ArrayList<String> _l, ArrayList<String> _tknzs, ArrayList<Token> _tks){
		...
		this.tokenizerStringGenerator = tokenizerStr(this.tokenizers);
	...
	public Branch(String str){
		...
		this.tokenizerStringGenerator = tokenizerStr(_tokenizers);

		checkRep();

	}
	//BranchStringGenerator function
	private ArrayList<String> branchStr (ArrayList<Token> tokens){
	...
	private ArrayList<String> tokenizerStr (ArrayList<String> tokenizers){
	...
	public double scoreString(String str){
		...
		for(int i=0; i<tokenStructs.size();i++){
			...
			if(i<tokeniseStr.size()) tokens.add(tokeniseStr.get(i));
	...
	public ArrayList<String> tokenizeString (String str){
		...
		for(String s : splitted) result.add(s);
	...
	public Branch learnString(String str){
		...
		for(int i = 0; i<tokenStructs.size(); i++){
			...
			if(i<tokeniseStr.size()) strTokens.add(tokeniseStr.get(i));
	...
	public Branch reopened(){
		...
		for(Token t : tokenStructs) reTok.add(t.reopened());
